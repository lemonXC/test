...
export const StatusColor = {
  ...
  [IssueStatus.SUPERVISE]: "#ee0a24", // 红色
};
...
export class IssueStatusManager {
  ...
  static canTransitionTo(currentStatus, targetStatus) {
    const transitions = {
      [IssueStatus.PENDING]: [IssueStatus.PROCESSING, IssueStatus.SUPERVISE],
      [IssueStatus.PROCESSING]: [IssueStatus.RESOLVED, IssueStatus.SUPERVISE],
      [IssueStatus.RESOLVED]: [IssueStatus.REVIEWED],
      [IssueStatus.REVIEWED]: [], // 已评价状态不能再转换
      [IssueStatus.SUPERVISE]: [IssueStatus.PROCESSING], // 督办后可以转为处理中
    };
